...
describe("attestation_registry", () => {
    ...
    before(async () => {
        ...
        const ethAddressBytes = Buffer.from(allocatorAddress.slice(2), "hex");
        const padded = Buffer.concat([Buffer.alloc(12), ethAddressBytes]); // 32 bytes
